...
import java.sql.*;
public class UpdateStudentDetail extends Frame implements ActionListener,ItemListener
{
Connection con;
...
public void setUpUpdateStudentDetail()
{
...
try
{
String studentid=ch0.getSelectedItem();
pst = con.prepareStatement("update newstudent set stuname='"+a2+"',fathername='"+a3+"',address='"+a4+"',course='"+a5+"',branch='"+a6+"',semester='"+a7+"',sessionstart='"+a8+"',sessionend='"+a9+"',department='"+a10+"' where studentid='"+studentid+"'");
pst.executeUpdate();
}
